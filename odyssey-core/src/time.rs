...
impl<HeaderId, T: ConcretizeTime<HeaderId, Serialized = CausalTime<T>>, V> ConcretizeTime<HeaderId> for LWW<T, V> {
    type Serialized = LWW<CausalTime<T>, V>;
...
impl<HeaderId: Clone, K: ConcretizeTime<HeaderId, Serialized = CausalTime<K>>, V, Op: ConcretizeTime<HeaderId>> ConcretizeTime<HeaderId> for TwoPMapOp<K, V, Op> {
    type Serialized = TwoPMapOp<CausalTime<K>, V, Op::Serialized>;
